...
class NS_NO_VTABLE NS_SCRIPTABLE nsINativeEvents : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD MouseMove(nsISupports *aNode, PRInt32 startX, PRInt32 startY, PRInt32 endX, PRInt32 endY, PRInt32 duration) = 0;
  ...
  /* void mousePress (in nsISupports aNode, in long button, in long x, in long y); */
  NS_SCRIPTABLE NS_IMETHOD MousePress(nsISupports *aNode, PRInt32 x, PRInt32 y, PRInt32 button) = 0;

  /* void mouseRelease (in nsISupports anode, in long button, in long x, in long y); */
...
#define NS_DECL_NSINATIVEEVENTS \
  ...
  NS_SCRIPTABLE NS_IMETHOD MouseMove(nsISupports *aNode, PRInt32 startX, PRInt32 startY, PRInt32 endX, PRInt32 endY, PRInt32 duration); \
...
#define NS_FORWARD_NSINATIVEEVENTS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD MouseMove(nsISupports *aNode, PRInt32 startX, PRInt32 startY, PRInt32 endX, PRInt32 endY, PRInt32 duration) { return _to MouseMove(aNode, startX, startY, endX, endY, duration); } \
...
#define NS_FORWARD_SAFE_NSINATIVEEVENTS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD MouseMove(nsISupports *aNode, PRInt32 startX, PRInt32 startY, PRInt32 endX, PRInt32 endY, PRInt32 duration) { return !_to ? NS_ERROR_NULL_POINTER : _to->MouseMove(aNode, startX, startY, endX, endY, duration); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD MouseRelease(nsISupports *aNode, PRInt32 x, PRInt32 y, PRInt32 button) { return !_to ? NS_ERROR_NULL_POINTER : _to->MousePress(aNode, x, y, button); } \
